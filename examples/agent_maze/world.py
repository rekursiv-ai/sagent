...
_DIG_HP = 2  # house-ignore[globals] -- Ticks to break a diggable wall (retunable).
PLATE_LETTERS: Final = "abcdefgh"  # `a` paired-plate lock: two tiles sharing a letter.
PRESS_WINDOW = 10  # house-ignore[globals] -- Ticks a press stays armed (retunable).
PRESS_CHARGES = 6  # house-ignore[globals] -- Presses per agent (retunable).
