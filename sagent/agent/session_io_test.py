...
def test_serialize_tool_state_round_trip(tmp_path: Path) -> None:
    ...
    state.depth = 2
    state.additional_dirs = ["/tmp/a"]  # noqa: S108 -- The path is a fixture string, never opened as a real temporary file.
    state.invoked_rules.add("/tmp/a/.sagent/rules/python.md")  # noqa: S108 -- The path is a fixture string, never opened as a real temporary file.
    state.read_cache["/tmp/x.txt"] = ReadCacheEntry(  # noqa: S108 -- The path is a fixture string, never opened as a real temporary file.
        offset=0,
        limit=100,
        last_lines=10,
        mtime=1234.5,
    ...
    assert restored.read_cache["/tmp/x.txt"].mtime == 1234.5  # noqa: S108 -- The path is a fixture string, never opened as a real temporary file.
