...
class TensorBase(metaclass=_TensorMeta):
    ...
    # A rank-0 tensor's `tolist()` is a bare scalar, not a list; the narrower
    # type is deliberate so that site is steered to `.item()`.
