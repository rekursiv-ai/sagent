...
from torch._C import (
    ...
    _dynamo as _dynamo,
    _export as _export,
    _functionalization as _functionalization,
    _functorch as _functorch,
    _lazy as _lazy,
    _lazy_ts_backend as _lazy_ts_backend,
    _nn as _nn,
    _onnx as _onnx,
    _VariableFunctions as _VariableFunctions,
    _verbose as _verbose,
)
from torch._prims_common import DeviceLikeType as DeviceLikeType
from torch.autograd.graph import Node as _Node
from torch.cuda import _POOL_HANDLE as _POOL_HANDLE
...
from torch.types import (
    ...
    _bool as _bool,
    _bytes as _bytes,
    _complex as _complex,
    _device as _device,
    _dispatchkey as _dispatchkey,
    _dtype as _dtype,
    _float as _float,
    _int as _int,
    _layout as _layout,
    _qscheme as _qscheme,
    _size as _size,
    _str as _str,
    _symsize as _symsize,
)
...
class Stream:
    ...
    @overload
    def __new__(
        cls, device: DeviceLikeType | None = ..., *, priority: _int = ...
    ) -> Self: ...
    @overload
    def __new__(
        cls,
...
class AliasInfo:
    ...
    after_set: set[str]
    def __init__(
        self, is_write: _bool, before_set: set[str], after_set: set[str]
    ) -> None: ...
...
class FileCheck:
    ...
    def check_count(
        self, test_string: str, count: _int, exactly: _bool = ...
    ) -> FileCheck: ...
...
class PyTorchFileWriter:
    @overload
    def __init__(
        self, name: str, compute_crc32: _bool = ..., storage_alignment: _int = ...
    ) -> None: ...
    @overload
    def __init__(
        self,
        buffer: IO[bytes],
        compute_crc32: _bool = ...,
        storage_alignment: _int = ...,
    ) -> None: ...
    def write_record(
        self, name: str, data: Storage | bytes | _int, size: _int
    ) -> None: ...
...
class _DispatchModule:
    ...
    def def_name_t_t(
        self, name: str, dispatch: str, debug: str = ...
    ) -> _DispatchModule: ...
    def def_schema_t_t(
        self, schema: str, dispatch: str, alias: str, debug: str = ...
    ) -> _DispatchModule: ...
    def impl_t_t(
        self, name: str, dispatch: str, debug: str = ...
    ) -> _DispatchModule: ...
    ...
    def fallback(
        self, dispatch: _dispatchkey, func: Callable, with_keyset: _bool = ...
    ) -> None: ...
...
class TensorBase(metaclass=_TensorMeta):
    ...
    def __setitem__(
        self, indices: _Index | tuple[_Index, ...], value: Tensor | Number, /
    ) -> None: ...
    ...
    def addcdiv(
        self, tensor1: Tensor, tensor2: Tensor, *, value: Number | _complex = ...
    ) -> Tensor: ...
    def addcdiv_(
        self, tensor1: Tensor, tensor2: Tensor, *, value: Number | _complex = ...
    ) -> Tensor: ...
    ...
    @overload
    def align_to(
        self, order: Sequence[str | EllipsisType | None], ellipsis_idx: _int
    ) -> Tensor: ...
    @overload
    ...
    def aminmax(
        self, *, dim: _int | None = ..., keepdim: _bool = ...
    ...
    @overload
    def argsort(
        self, *, stable: _bool, dim: _int = ..., descending: _bool = ...
    ) -> Tensor: ...
    @overload
    def argsort(self, dim: _int = ..., descending: _bool = ...) -> Tensor: ...
    @overload
    def argsort(
        self, dim: str | EllipsisType | None, descending: _bool = ...
    ) -> Tensor: ...
    ...
    @overload
    def bernoulli_(
        self, p: _float = ..., *, generator: Generator | None = ...
    ) -> Tensor: ...
    def bfloat16(self) -> Tensor: ...
    def bincount(
        self, weights: Tensor | None = ..., minlength: _int | SymInt = ...
    ) -> Tensor: ...
    @overload
    ...
    @overload
    def clamp(
        self, min: Number | _complex | None = ..., max: Number | _complex | None = ...
    ) -> Tensor: ...
    @overload
    ...
    @overload
    def cumprod(
        self, dim: str | EllipsisType | None, *, dtype: _dtype | None = ...
    ) -> Tensor: ...
    @overload
    ...
    def diag_embed(
        self, offset: _int = ..., dim1: _int = ..., dim2: _int = ...
    ) -> Tensor: ...
    ...
    def diagonal_scatter(
        self, src: Tensor, offset: _int = ..., dim1: _int = ..., dim2: _int = ...
    ) -> Tensor: ...
    def diff(
        self,
        n: _int = ...,
    ...
    def div(
        self, other: Tensor | Number, *, rounding_mode: str | None = ...
    ) -> Tensor: ...
    def div_(
        self, other: Tensor | Number, *, rounding_mode: str | None = ...
    ) -> Tensor: ...
    ...
    @overload
    def divide(
        self, other: Number | _complex, *, rounding_mode: str | None
    ) -> Tensor: ...
    @overload
    ...
    @overload
    def expand(
        self, size: Sequence[_int | SymInt], *, implicit: _bool = ...
    ) -> Tensor: ...
    @overload
    ...
    def exponential_(
        self, lambd: _float = ..., *, generator: Generator | None = ...
    ) -> Tensor: ...
    @overload
    ...
    def fill_diagonal_(
        self, fill_value: Number | _complex, wrap: _bool = ...
    ) -> Tensor: ...
    def fix(self) -> Tensor: ...
    def fix_(self) -> Tensor: ...
    @overload
    def flatten(
        self, start_dim: _int, end_dim: _int, out_dim: str | EllipsisType | None
    ) -> Tensor: ...
    @overload
    ...
    def floor_divide_(
        self, other: Tensor | Number | torch.SymInt | torch.SymFloat
    ) -> Tensor: ...
    ...
    @overload
    def gather(
        self, dim: _int, index: Tensor, *, sparse_grad: _bool = ...
    ) -> Tensor: ...
    @overload
    def gather(
        self, dim: str | EllipsisType | None, index: Tensor, *, sparse_grad: _bool = ...
    ) -> Tensor: ...
    ...
    @overload
    def hash_tensor(
        self, dim: _int | _size = ..., *, keepdim: _bool = ..., mode: _int = ...
    ) -> Tensor: ...
    @overload
    def hash_tensor(
        self, *dim: _int, keepdim: _bool = ..., mode: _int = ...
    ) -> Tensor: ...
    ...
    @overload
    def index_copy(
        self, dim: str | EllipsisType | None, index: Tensor, source: Tensor
    ) -> Tensor: ...
    @overload
    ...
    @overload
    def index_fill(
        self, dim: str | EllipsisType | None, index: Tensor, value: Tensor
    ) -> Tensor: ...
    @overload
    def index_fill(
        self, dim: _int, index: Tensor, value: Number | _complex
    ) -> Tensor: ...
    @overload
    def index_fill(
        self, dim: str | EllipsisType | None, index: Tensor, value: Number | _complex
    ) -> Tensor: ...
    @overload
    ...
    @overload
    def kthvalue(
        self, k: _int | SymInt, dim: _int = ..., keepdim: _bool = ...
    ...
    @overload
    def logsumexp(
        self, dim: Sequence[str | EllipsisType | None], keepdim: _bool = ...
    ) -> Tensor: ...
    ...
    @overload
    def max(
        self, dim: str | EllipsisType | None, keepdim: _bool = ...
    ...
    def mul_(
        self, other: Tensor | Number | _complex | torch.SymInt | torch.SymFloat
    ) -> Tensor: ...
    def multinomial(
        self,
    ...
    @overload
    def narrow(
        self, dim: _int, start: _int | SymInt, length: _int | SymInt
    ) -> Tensor: ...
    def narrow_copy(
        self, dim: _int, start: _int | SymInt, length: _int | SymInt
    ) -> Tensor: ...
    ...
    def nonzero_static(
        self, *, size: _int | SymInt, fill_value: _int = ...
    ) -> Tensor: ...
    def normal_(
        self,
        mean: _float = ...,
    ...
    def ormqr(
        self, input2: Tensor, input3: Tensor, left: _bool = ..., transpose: _bool = ...
    ) -> Tensor: ...
    ...
    @overload
    def prod(
        self, dim: _int, keepdim: _bool = ..., *, dtype: _dtype | None = ...
    ) -> Tensor: ...
    @overload
    def prod(
        self,
    ...
    def put_(
        self, index: Tensor, source: Tensor, accumulate: _bool = ...
    ) -> Tensor: ...
    ...
    @overload
    def random_(
        self, from_: _int, to: _int | None, *, generator: Generator | None = ...
    ) -> Tensor: ...
    @overload
    ...
    def renorm(
        self, p: Number | _complex, dim: _int, maxnorm: Number | _complex
    ) -> Tensor: ...
    def renorm_(
        self, p: Number | _complex, dim: _int, maxnorm: Number | _complex
    ) -> Tensor: ...
    ...
    @overload
    def resize_(
        self, *size: _int | SymInt, memory_format: memory_format | None = ...
    ) -> Tensor: ...
    def resize_as_(
        self, the_template: Tensor, *, memory_format: memory_format | None = ...
    ) -> Tensor: ...
    ...
    def roll(
        self, shifts: _int | SymInt | Sequence[_int | SymInt], dims: _int | _size = ...
    ) -> Tensor: ...
    ...
    @overload
    def scatter(
        self, dim: _int, index: Tensor, value: Number | _complex, *, reduce: str
    ) -> Tensor: ...
    @overload
    def scatter(
        self, dim: str | EllipsisType | None, index: Tensor, src: Tensor
    ) -> Tensor: ...
    @overload
    ...
    def select_scatter(
        self, src: Tensor, dim: _int, index: _int | SymInt
    ) -> Tensor: ...
    @overload
    def set_(
        self,
    ...
    @overload
    def sort(
        self, *, stable: _bool | None, dim: _int = ..., descending: _bool = ...
    ) -> torch.return_types.sort: ...
    @overload
    def sort(
        self, dim: _int = ..., descending: _bool = ...
    ) -> torch.return_types.sort: ...
    @overload
    def sort(
        self,
    ...
    @overload
    def split(self, split_size: _int, dim: _int = ...) -> tuple[Tensor, ...]: ...
    @overload
    def split(
        self, split_size: Sequence[_int], dim: _int = ...
    ) -> tuple[Tensor, ...]: ...
    def split_with_sizes(
        self, split_sizes: Sequence[_int | SymInt], dim: _int = ...
    ) -> tuple[Tensor, ...]: ...
    ...
    @overload
    def std(
        self, dim: _int | _size | None, unbiased: _bool = ..., keepdim: _bool = ...
    ) -> Tensor: ...
    @overload
    def std(
        self,
    ...
    @overload
    def subtract(
        self, other: Number | _complex, alpha: Number | _complex = ...
    ) -> Tensor: ...
    @overload
    ...
    def svd(
        self, some: _bool = ..., compute_uv: _bool = ...
    ...
    @overload
    def tensor_split(
        self, indices: Sequence[_int | SymInt], dim: _int = ...
    ) -> tuple[Tensor, ...]: ...
    @overload
    def tensor_split(
        self, tensor_indices_or_sections: Tensor, dim: _int = ...
    ) -> tuple[Tensor, ...]: ...
    @overload
    def tensor_split(
        self, sections: _int | SymInt, dim: _int = ...
    ) -> tuple[Tensor, ...]: ...
    @overload
    ...
    def to_dense(
        self, dtype: _dtype | None = ..., *, masked_grad: _bool | None = ...
    ) -> Tensor: ...
    def to_mkldnn(self, dtype: _dtype | None = ...) -> Tensor: ...
    def to_padded_tensor(
        self, padding: _float, output_size: Sequence[_int | SymInt] | None = ...
    ) -> Tensor: ...
    @overload
    def to_sparse(
        self,
        *,
        layout: _layout | None = ...,
        blocksize: _int | _size | None = ...,
        dense_dim: _int | None = ...,
    ) -> Tensor: ...
    @overload
    def to_sparse(self, sparse_dim: _int) -> Tensor: ...
    def to_sparse_bsc(
        self, blocksize: _int | _size, dense_dim: _int | None = ...
    ) -> Tensor: ...
    def to_sparse_bsr(
        self, blocksize: _int | _size, dense_dim: _int | None = ...
    ) -> Tensor: ...
    ...
    @overload
    def transpose(
        self, dim0: str | EllipsisType | None, dim1: str | EllipsisType | None
    ) -> Tensor: ...
    ...
    def unsafe_split(
        self, split_size: _int | SymInt, dim: _int = ...
    ) -> tuple[Tensor, ...]: ...
...
class EnumType(JitType):
    def __init__(
        self, qualified_name: str, value_type: JitType, enum_names_values: list[Any]
    ) -> None: ...
...
class _NodeBase:
    ...
    _next: FxNode
    def __init__(
        self, graph: Any, name: str, op: str, target: Any, return_type: Any
    ) -> None: ...
