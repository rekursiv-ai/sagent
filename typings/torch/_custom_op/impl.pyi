...
class CustomOp:
    def __init__(
        self, lib, cpp_ns, schema, operator_name, ophandle, *, _private_access=...
    ) -> None: ...
    def __call__(self, *args, **kwargs) -> Any: ...
    def impl(
        self, device_types: str | typing.Iterable[str], _stacklevel=...
    ) -> typing.Callable: ...
    ...
    def impl_backward(
        self, output_differentiability=..., _stacklevel=...
    ) -> Callable[..., None]: ...
...
def find_ophandle_or_throw(
    cpp_ns: str, operator_name: OperatorName
