...
def create_binary_slice(
    start: int | None, end: int | None, store: bool = ...
) -> list[Instruction]: ...
...
def remove_graph_break_if_leaf_instructions(
    instructions: list[Instruction],
) -> None: ...
...
def transform_code_object(
    ...
    transformations: Callable[
        [list[Instruction], dict[str, Any]], DynamoTracerOutput | None
    ],
    safe: bool = ...,
...
def populate_kw_names_argval(
    instructions: Sequence[Instruction], consts: Any
) -> None: ...
def cleaned_instructions(
    code: types.CodeType, safe: bool = ...
) -> list[Instruction]: ...
...
def bytecode_from_template(
    fn: Callable[..., Any],
    varname_map: Mapping[Any, Any] | None = ...,
    noreturn: bool = ...,
    noprefix: bool = ...,
) -> list[Instruction]: ...
