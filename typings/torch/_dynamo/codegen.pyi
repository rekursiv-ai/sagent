...
class PyCodegen:
    ...
    def restore_stack(
        self, stack_values: list[Any], *, value_from_source: bool = ...
    ) -> None: ...
    def graph_output_vars(self) -> list[VariableTracker]: ...
    def call_reconstruct(self, value: VariableTracker | Source | GraphArg) -> None: ...
    def add_push_null(
        self, gen_fn: Callable[[], None], call_function_ex: bool = ...
    ) -> None: ...
    def __call__(
        self, value: VariableTracker | Source, allow_cache: bool = ...
    ) -> None: ...
    ...
    def load_function_name(
        self, fn_name: str, push_null: bool, num_on_stack: int = ...
    ) -> list[Instruction]: ...
