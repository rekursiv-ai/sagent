...
class GuardManagerWrapper:
    ...
    def get_manager_line(
        self, guard_manager: GuardManager, accessor_str: str | None = ...
    ) -> str: ...
...
class GuardBuilder(GuardBuilderBase):
    ...
    def guard_on_dict_keys_and_order(
        self, value: dict[Any, Any], guard: Guard
    ) -> None: ...
    ...
    def NOT_PRESENT_IN_GENERIC_DICT(
        self, guard: Guard, attr: Any | None = ...
    ) -> None: ...
    ...
    def id_match_unchecked(
        self, guard: Guard, recompile_hint: str | None = ...
    ) -> None: ...
...
class PyExprCSEPass:
    ...
    class Replacer(ast.NodeTransformer):
        def __init__(
            self, config: PyExprCSEPass.Config, gen_name: Callable[[], str]
        ) -> None: ...
...
def build_guard_function(
    code_parts: list[str], closure_args: str
) -> tuple[str, str]: ...
