...
class OutputGraph(OutputGraphGuardsState):
    ...
    def save_global_state(
        self,
        out: dict[str, tuple[Callable[..., Any], bool]] | None = ...,
    ) -> None: ...
    ...
    def add_graph_finalizer(
        self,
        register_finalizer: Callable[[fx.GraphModule], None],
    ) -> None: ...
...
class DynamoTracerOutput:
    ...
    def __init__(
        self,
        tracer: InstructionTranslatorBase,
        error: Any | None = ...,
    ) -> None: ...
...
class SubgraphTracer(fx.Tracer):
    ...
    def track_produced_symints(
        self,
        example_value: Any,
        e_proxy: LazyProxy | torch.fx.Proxy,
    ) -> None: ...
