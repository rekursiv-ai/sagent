...
class OutputGraph(OutputGraphGuardsState):
    ...
    def add_backward_state_hook(
        self, hook: VariableTracker, prefix: str = ...
    ...
    def subtracer(
        self, source_target: Target | None, prior_tracer: SubgraphTracer
    ) -> Generator[fx.Tracer]: ...
    @property
    ...
    def save_global_state(
        self, out: dict[str, tuple[Callable[..., Any], bool]] | None = ...
    ) -> None: ...
...
class DynamoTracerOutput:
    ...
    def __init__(
        self, tracer: InstructionTranslatorBase, error: Any | None = ...
    ) -> None: ...
