...
class ReinplaceCounters:
    ...
    @classmethod
    def add_missed_opportunities(
        cls, trigger: ReInplaceTrigger, count: int
    ) -> None: ...
    @classmethod
    def clear(cls) -> None: ...
    @classmethod
...
def tabulate(
    rows: list[tuple[str, Any]] | list[list[Any]], headers: tuple[str, ...] | list[str]
) -> str: ...
...
class CompileEventLogger:
    ...
    @staticmethod
    def add_toplevel(
        log_level: CompileEventLogLevel, overwrite: bool = ..., **metadata: object
    ) -> None: ...
    @staticmethod
    def increment(
    ...
    def increment_toplevel(
        key: str, value: int = ..., log_level: CompileEventLogLevel = ...
    ) -> None: ...
    @staticmethod
    def add_to_set(
    ...
    def add_to_set_toplevel(
        key: str, value: Any, log_level: CompileEventLogLevel = ...
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def instant(
        event_name: str, metadata: dict[str, Any], time_ns: int | None = ...
    ) -> None: ...
    @staticmethod
    def try_add_pt2_compile(event_name: str, **metadata: object) -> None: ...
    @staticmethod
    def try_(
        method_fn: Callable[_P, Any], *args: _P.args, **kwargs: _P.kwargs
    ) -> None: ...
...
@overload
def compile_times(
    repr: Literal["csv"], aggregate: bool = ...
) -> tuple[list[str], list[object]]: ...
def compile_times(
    repr: str = ..., aggregate: bool = ...
...
def timed(
    model: Any, example_inputs: Iterable[Any], times: int = ...
) -> tuple[Any, float]: ...
...
def get_unique_name_wrt(
    prefix: str, *containers: Any, requires_suffix: bool = ...
) -> str: ...
...
def get_fake_value(
    node: torch.fx.Node, tx: InstructionTranslatorBase, allow_non_graph_fake: bool = ...
) -> Any: ...
...
def get_custom_getattr(value: Any, ignore_nn_module_getattr: bool = ...) -> None: ...
...
def set_locals_to_steal(
    gm: torch.fx.GraphModule, locals_to_steal: list[Any]
) -> None: ...
