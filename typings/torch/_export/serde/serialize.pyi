...
def serialize_torch_artifact(
    artifact: Any | None, pickle_protocol: int = ...
) -> bytes: ...
...
class GraphModuleSerializer(metaclass=Final):
    ...
    def serialize_graph_module_metadata(
...
class ExportedProgramSerializer(metaclass=Final):
    def __init__(
        self, opset_version: dict[str, int] | None = ..., pickle_protocol: int = ...
    ) -> None: ...
...
class GraphModuleDeserializer(metaclass=Final):
    ...
    def deserialize_inputs(
        self, target, serialized_node: Node
    ) -> tuple[tuple[Any, ...], OrderedDict[str, Any]]: ...
    def deserialize_hoo_inputs(
        self, inputs: list[NamedArgument]
    ...
    def deserialize_sym_op_outputs(
...
def canonicalize(
    ep: ExportedProgram, constants: set[str] | None = ...
) -> ExportedProgram: ...
...
def register_extension(
    op_type: type[Any], extension_handler: type[ExtensionHandler]
) -> None: ...
