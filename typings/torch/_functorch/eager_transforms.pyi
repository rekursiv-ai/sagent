...
def enable_inplace_requires_grad(enabled) -> Generator[None, Any]: ...
...
def vjp(
    ...
    *primals,
    ...
    tuple[PyTree, Callable[..., PyTree], PyTree | Any]
    | tuple[PyTree, Callable[..., PyTree]]
): ...
@contextlib.contextmanager
def grad_increment_nesting() -> Generator[int, Any]: ...
def enter_jvp_nesting() -> int: ...
def exit_jvp_nesting() -> None: ...
@contextlib.contextmanager
def jvp_increment_nesting() -> Generator[int, Any]: ...
