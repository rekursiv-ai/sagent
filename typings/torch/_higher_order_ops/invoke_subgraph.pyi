...
class InvokeSubgraphAutogradOp(torch.autograd.Function):
    @staticmethod
    def forward(ctx, subgraph, identifier, output_metadata, *operands) -> None: ...
    @staticmethod
    def backward(ctx, *grad_outs) -> tuple[None, None, None, *tuple[Any, ...]]: ...

@invoke_subgraph.py_autograd_impl
def _(subgraph, identifier, *operands) -> None: ...
...
def _(proxy_mode: ProxyTorchDispatchMode, subgraph, identifier, *operands) -> None: ...
