...
class PreservesZeros(SymPyOps, DefaultHandler):
    ...
    def store(
        self, name: str, index: sympy.Expr, value: TypedExpr, mode: StoreMode = ...
    ) -> None: ...
...
class RecordLowPrecisionOps(DefaultHandler):
    ...
    @staticmethod
    def store(
        name: str, index: sympy.Expr, value: TypedExpr, mode: StoreMode = ...
    ) -> None: ...
    def check_bounds(
...
def can_codegen_without_upcasts(
    prologue: SchedulerNode, disallow_fp32_ops: bool = ...
) -> bool: ...
