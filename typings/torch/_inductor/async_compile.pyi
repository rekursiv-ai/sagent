...
class AsyncCompile:
    ...
    ) -> StaticAutotunerFuture | CachingAutotuner | LambdaFuture: ...
    def multi_kernel(self, *args, **kwargs) -> Any: ...
    def cpp(self, source_code: str) -> LambdaFuture: ...
    def cpp_pybinding(self, argtypes: list[str], source_code: str) -> LambdaFuture: ...
    def cuda(self, source_code, dst_file_ext, aot_compile=...) -> Any: ...
    def rocm(self, source_code, dst_file_ext, aot_compile=...) -> Any: ...
    def halide(self, meta: HalideMeta, source_code: str) -> LambdaFuture: ...
    def cutedsl(
        self, kernel_name: str, source_code: str
    ) -> CuteDSLKernelWrapper | LambdaFuture: ...
