...
def simplify_index_in_vec_range(
    index: sympy.Expr, var: sympy.Expr, vec_length: int
) -> Expr: ...
@functools.lru_cache
def stride_at_vec_range(
    index: sympy.Expr, var: sympy.Symbol, vec_length: int | None = ...
) -> Zero | Expr: ...
...
class CppVecOverrides(CppOverrides):
    ...
    @staticmethod
    def index_expr(expr, dtype) -> CppCSEVariable | None: ...
    @staticmethod
    def frexp(x) -> tuple[Any, ...] | tuple[Any, Any]: ...
...
class CppKernel(Kernel):
    ...
    def masked(self, mask) -> Generator[CppCSEVariable | Any, Any]: ...
    def scale_index_with_offset(
        self, index: sympy.Expr, scale=..., itervar_idx=..., offset=...
    ) -> Expr: ...
    def index_to_str(self, index: sympy.Expr) -> str: ...
    def index_indirect_depends_on(
        self, index: sympy.Expr, itervar: sympy.Symbol
    ) -> bool: ...
    ...
    ) -> CSEVariable | tuple[str, str, str] | str: ...
    def store_reduction(self, name, index, value) -> None: ...
    def set_ranges(
        self, lengths, reduction_lengths
    ...
    @contextlib.contextmanager
    def write_to_suffix(self) -> Generator[None, Any]: ...
    ...
    def codegen_conditions(
        ...
        code: BracesBuffer,
        prefix: str | None = ...,
        var: sympy.Symbol | None = ...,
    ) -> bool: ...

class CppVecKernel(CppKernel):
    overrides = CppVecOverrides
    def __init__(
        self, args, num_threads, tiling_factor, tiling_idx, tail_size=...
    ) -> None: ...
...
class CppScheduling(BaseScheduling):
    ...
    def fuse(
        ...
        ForeachKernelSchedulerNode | FusedSchedulerNode | OuterLoopFusedSchedulerNode
    ): ...
    ...
    def codegen_node(
        self, node: OuterLoopFusedSchedulerNode | FusedSchedulerNode | SchedulerNode
    ) -> None: ...
...
class KernelGroup:
    ...
    def call_kernel(
        self, wrapper, kernel_name, debug_handle: int | None = ...
    ) -> None: ...
