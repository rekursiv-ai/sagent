...
class LocalBufferContext:
    ...
    def add_local_buffer(
        ...
        global_buffers: list[ir.Buffer] | None = ...,
    ) -> None: ...
    def localize_function(
        self,
        fn: Callable[..., Any],
        rewrite_index: Callable[
            [LocalizeBufferHandler, sympy.Expr, str],
            sympy.Expr,
        ] = ...,
    ) -> Callable[..., Any]: ...
    def localize_nodes(
...
def may_unify_binary_op_mask_type(a, b) -> Generator[Any] | tuple[Any, Any]: ...
...
def template_fusion_with_epilogues_supported(
    template: BaseSchedulerNode,
    epilogues: list[BaseSchedulerNode],
) -> tuple[bool, bool]: ...
