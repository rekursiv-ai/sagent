...
class CppWrapperCpu(PythonWrapperCodegen):
    ...
    def codegen_input_device_type_var_decl(
        self,
        code: IndentedBuffer,
        name,
    ) -> None: ...
    ...
    def generate_c_shim_extern_kernel_alloc(
        self,
        extern_kernel: ir.ExternKernelAlloc,
        args: list[str],
    ) -> None: ...
    def generate_c_shim_fallback_kernel(
        self,
        fallback_kernel: ir.FallbackKernel,
        args: list[str],
    ) -> None: ...
    ...
    def codegen_subgraph_prefix(
        self,
        subgraph,
        outer_inputs,
        outer_outputs,
    ) -> None: ...
    def codegen_subgraph_suffix(
        self,
        subgraph,
        outer_inputs,
        outer_outputs,
    ...
    def create_tmp_raii_handle_var_if_needed(
        self,
        handle: str,
        writer: HasWriteLine | list[str] | None = ...,
    ) -> str: ...
