...
def get_manager(
    device_index: int, create_if_none_exists: bool = ...
...
def dynamo_timed_cudagraph(
    name: str, compile_id: CompileId | None, mode: CompilationMode | None
) -> Generator[Any]: ...
def cudagraphify(
    model: ModelType,
    inputs: list[InputType],
...
class StorageWeakRefWrapper:
    ...
    def __init__(
        ...
        extra_ref_check: Callable[[], bool] | None = ...,
    ) -> None: ...
    @classmethod
...
class CUDAGraphTreeManager:
    ...
    def check_warn_on_unable_to_start_executing(
