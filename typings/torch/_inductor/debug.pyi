...
def has_dot() -> bool: ...
def draw_buffers(
    nodes: list[BaseSchedulerNode], print_graph: bool = ..., fname: str | None = ...
) -> None: ...
...
class DebugContext:
    ...
    def fopen(
        self, filename: str, write_mode: str = ..., *args: Any, **kwargs: Any
    ) -> IO[Any]: ...
    @contextlib.contextmanager
    def fopen_context(
        self, filename: str, write_mode: str = ..., *args: Any, **kwargs: Any
...
class DebugFormatter:
    ...
    def draw_orig_fx_graph(
        self, gm: torch.fx.GraphModule, nodes: SchedulerNodeList
    ) -> None: ...
