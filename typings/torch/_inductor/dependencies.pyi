...
class MemoryDep(Dep):
    ...
    def has_unbacked_symbols(self) -> bool: ...
    def is_contiguous(self) -> bool: ...
    def stride1_for_last_dim(
        self, result_for_complex_expression: bool = ...
    ) -> bool: ...
...
class _RecordLoadStoreInner(V.MockHandler):
    ...
    def drop_unused_symbols(
        index: int | sympy.Expr, var_names: list[sympy.Expr], sizes: list[sympy.Expr]
    ) -> None: ...
    def canonicalize(
    ...
    def store(
        self, name: str, index: sympy.Expr, value: str, mode: str | None = ...
    ) -> str: ...
...
def var_builder(
    prefix: str,
) -> tuple[VarRanges, Callable[[sympy.Expr], sympy.Symbol]]: ...
