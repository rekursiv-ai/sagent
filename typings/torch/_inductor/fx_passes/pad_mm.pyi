...
def should_pad_common(
    mat1: Tensor, mat2: Tensor, input: Tensor | None = ...
) -> bool: ...
...
def pad_mat1(
    mat1: Tensor, *, m_padded_length: int, k_padded_length: int, is_bmm: bool = ...
) -> Tensor: ...
def pad_mat2(
    mat2: Tensor, *, k_padded_length: int, n_padded_length: int, is_bmm: bool = ...
) -> Tensor: ...
def pad_mm(
    mat1: Tensor,
    mat2: Tensor,
