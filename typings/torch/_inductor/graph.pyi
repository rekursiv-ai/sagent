...
def mark_nodes_dislike_padding(
    g: Graph,
    user_visible_output_strides: dict[Node, tuple[int, ...]],
) -> None: ...
...
class GraphLowering(torch.fx.Interpreter):
    ...
    def get_allocation_storage_size(
        self,
        node: ir.Buffer | WorkspaceArg | ir.TorchBindObject,
    ) -> Expr: ...
    def has_feature(
        self,
    ...
    def register_users_of(
        self,
        node_output: Iterable[ir.IRNode] | ir.IRNode,
    ) -> None: ...
    ...
    @contextmanager
    def set_current_node(self, node: torch.fx.Node) -> Generator[None, Any]: ...
    @contextmanager
    ...
    def extract_autotune_inputs(
        self,
        example_inputs: list[int | float | torch.Tensor],
    ) -> None: ...
    ...
    def count_bytes(
        ...
        int,
        list[tuple[BaseSchedulerNode, int]],
        list[tuple[BaseSchedulerNode, float]],
    ]: ...
