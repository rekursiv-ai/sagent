...
from torch.fx.experimental.symbolic_shapes import ShapeEnv, SympyBoolean
...
def get_fill_order(
    seq: Sequence[int | torch.SymInt | Expr], shape_env: ShapeEnv | None = ...
) -> Sequence[int]: ...
...
def ir_node_to_tensor(
    x: IRNode | None, guard_shape: bool = ...
) -> torch.Tensor | None: ...
...
def try_match_insignificant_strides(
    tensor: IRNode, strides: Sequence[int | torch.SymInt]
) -> IRNode: ...
...
class IRNode:
    ...
    def str_helper(
        self, lines: Sequence[object], shorten: bool = ..., multiline: bool = ...
    ) -> str: ...
    ...
    def freeze_layout_with_stride_order(
        self, order: Sequence[int], allow_padding: bool = ...
    ) -> None: ...
...
class FlexibleLayout(Layout):
    ...
    @staticmethod
    def stride_ordered(
        sizes: Sequence[int], order: Sequence[int]
    ) -> Sequence[Expr]: ...
    @staticmethod
...
class CommBufferLayout(FixedLayout):
    ...
    group_name: str
    def __init__(
        self, layout: FlexibleLayout, comm_buffer_type: CommBufferType, group_name: str
    ) -> None: ...
...
class MutationLayoutSHOULDREMOVE(Layout):
    ...
    @classmethod
    def realize_into(
        cls, src: IRNode, dst: IRNode, unsafe_alias: bool = ...
    ) -> IRNode: ...
...
class Buffer(IRNode, CodegenSymbol):
    ...
    def freeze_layout_with_exact_strides(
        self, exact_strides: Sequence[int], allow_padding: bool = ...
    ) -> None: ...
    def is_zero_elements(self) -> bool: ...
    def make_loader(self) -> Callable[[Sequence[Expr]], OpsValue]: ...
    def codegen_reference(self, writer: IndentedBuffer | None = ...) -> str: ...
...
class ComputedBuffer(OperationBuffer):
    ...
    def get_default_sizes_body(
        ...
        tuple[list[Expr], list[Expr]], LoopBody, tuple[list[Expr], list[Expr]]
    ]: ...
...
class ChoiceCaller:
    def __init__(
        self, name: str, input_nodes: list[Buffer], layout: Layout, description: str
    ) -> None: ...
...
class MultiTemplateBuffer(TritonTemplateBuffer):
    ...
    def choice_timings(
        self, hint_override: int | None = ...
    ) -> dict[ChoiceCaller, float]: ...
    @contextlib.contextmanager
    def swap_as_triton_caller(
        self, caller: TritonTemplateCallerBase
    ) -> Iterator[None]: ...
...
class ConcatKernel(NopKernel):
    ...
    def can_realize_into_without_copy(
        cls, src: IRNode, dst: IRNode | None = ...
    ) -> bool: ...
    def get_free_symbol_uses(
        self, unbacked_only: bool = ...
    ) -> OrderedSet[sympy.Symbol]: ...
...
class ExternKernel(InputsKernel):
    ...
    def require_stride_order(
        cls, x: IRNode, order: Sequence[int], allow_padding: bool = ...
    ) -> IRNode: ...
    @classmethod
...
class TMADescriptorStable(TMADescriptor):
    def __init__(
        self, tensor: IRNode, block_shape: list[int | torch.SymInt]
    ) -> None: ...
...
class InplaceCopyFallback(ExternKernel):
    ...
    def get_unbacked_symbol_defs(self) -> OrderedSet[sympy.Symbol]: ...
    def __init__(
        self, layout: OutputSpec, inputs: Sequence[IRNode], constant_args: Sequence[Any]
    ) -> None: ...
    @classmethod
    def create(
        cls, dst: IRNode, src: IRNode, non_blocking: bool = ...
    ) -> InplaceCopyFallback: ...
