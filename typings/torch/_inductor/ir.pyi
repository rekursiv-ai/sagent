...
class IRNode:
    ...
    def freeze_layout_with_exact_strides(
        self,
        exact_strides: Sequence[_IntLike],
        allow_padding: bool = ...,
    ) -> None: ...
...
def is_stride_order_storage_and_layout(
    x: IRNode,
    stride_order: Sequence[int | Integer],
) -> bool: ...
...
class MultiTemplateBuffer(TritonTemplateBuffer):
    ...
    def swap_as_triton_caller(
        self,
        caller: TritonTemplateCallerBase,
    ) -> Iterator[None]: ...
...
class FallbackKernel(ExternKernelAlloc):
    ...
    @staticmethod
    def find_device(
        tensor_args: Sequence[torch.Tensor] | None,
        example_output: Sequence[Any],
    ) -> Any: ...
    def has_side_effects(self) -> bool: ...
    def get_inputs_that_alias_output(self) -> Sequence[str]: ...
    def get_mutation_names(self) -> Sequence[str]: ...
