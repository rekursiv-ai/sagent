...
class LoopBody:
    ...
    def bind_set_indirect_shim(
        self, var, size, check, wrap_neg
    ) -> Callable[..., None]: ...
...
class LoopBodyBlock:
    def __init__(
        self, body: LoopBody, fn: Callable[..., Any], args: list[Any]
    ) -> None: ...
...
class CountOps(DefaultHandler):
    def __init__(
        self, inner: OpsHandler[Any], counts: collections.Counter[str]
    ) -> None: ...

class CaptureIndexing(WrapperHandler):
    name = ...
    def __init__(
        self, inner: OpsHandler[Any], body: LoopBody, tracer: LightTracer
    ) -> None: ...
    ...
    def masked(
        self, mask_proxy, masked_body: Callable[..., Any], other_proxy
    ) -> Proxy: ...
    def scan(
        self,
        dtype_proxy,
    ...
    def indirect_indexing(
        self, index_proxy, size, check=..., wrap_neg=...
    ) -> Symbol: ...
