...
def group_foreach_args(
    arg_pairs: Iterable[tuple[Any, Any] | Any],
        ...
        tuple[
            tuple[
                ...
                | dict[
                    Any,
                    Any
                    | dict[Any, Any | dict[Any, Any] | list[Any] | tuple[Any, ...]]
                    | list[Any]
                    | tuple[Any, ...],
                ]
                | list[Any]
...
def div_mode(a, b, rounding_mode=...) -> TensorBox | ShapeAsConstantBuffer: ...
@register_lowering([aten.mul], broadcast=True)
def mul(a, b): ...
def get_constant_value(x: ir.IRNode) -> ir.Constant | None: ...
@register_lowering([prims.div], broadcast=True)
def div_prim(a, b) -> TensorBox | ShapeAsConstantBuffer: ...
@register_lowering(
    [aten.true_divide, aten.div.Tensor],
    broadcast=True,
    type_promotion_kind=ELEMENTWISE_TYPE_PROMOTION_KIND.INT_TO_FLOAT,
)
def div(a, b) -> TensorBox | ShapeAsConstantBuffer: ...
...
def cummax(
    ...
    tuple[TensorBox | ShapeAsConstantBuffer, Any]
    | PyTree
    | tuple[TensorBox | ShapeAsConstantBuffer, TensorBox | ShapeAsConstantBuffer | None]
): ...
