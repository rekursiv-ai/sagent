...
def is_pointwise_use(
    use: Node,
    is_pointwise_fn: Callable[[torch._ops.OpOverload], bool] = ...,
) -> bool: ...
...
def dominated_nodes(
    ...
    skip_filter: Callable[[Any], bool] | None = ...,
) -> OrderedSet[torch.fx.Node]: ...
def gather_origins(
    args: Sequence[IRNode],
...
class IndentedBuffer:
    ...
    def writelines(
        self,
        lines: Sequence[LineContext | DeferredLineBase | str],
    ) -> None: ...
...
def override_lowering(
    aten_op: Callable[..., Any],
    override_fn: Callable[..., Any],
) -> Iterator[None]: ...
def add_scheduler_init_hook(
    pre_fn: Callable[..., Any],
    post_fn: Callable[..., Any] | None = ...,
) -> Any: ...
...
def is_collective(
    ...
    op: torch._ops.OperatorBase | None = ...,
) -> bool: ...
...
def buf_name_to_fused_snode(
    ...
    name_to_fused_node: dict[str, Any],
) -> Any: ...
...
def num_fw_fixed_arguments(
    dynamo_gm_num_inputs: int,
    aot_fw_gm_num_inputs: int,
) -> int: ...
...
def maybe_get_suppress_shape_guards_ctx() -> contextlib.AbstractContextManager[
    None
]: ...
...
def copy_misaligned_inputs(
    ...
    return_pair_idxs: OrderedSet[int] | None = ...,
...
type CUDAGraphWrapperType = Callable[
    [PartitionFnType, CUDAGraphWrapperMetadata],
    PartitionFnType,
]
