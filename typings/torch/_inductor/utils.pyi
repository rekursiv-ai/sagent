...
def do_bench_using_profiling(
    fn: Callable[[], Any], warmup: int = ..., rep: int = ...
) -> float: ...
@functools.cache
...
def is_pointwise_use(
    use: Node, is_pointwise_fn: Callable[[torch._ops.OpOverload], bool] = ...
) -> bool: ...
...
class IndentedBuffer:
    ...
    def writelines(
        self, lines: Sequence[LineContext | DeferredLineBase | str]
    ) -> None: ...
...
def add_scheduler_init_hook(
    pre_fn: Callable[..., Any], post_fn: Callable[..., Any] | None = ...
) -> Any: ...
...
def is_collective(
    node: Node | Operation | None, op: torch._ops.OperatorBase | None = ...
) -> bool: ...
...
def num_fw_fixed_arguments(
    dynamo_gm_num_inputs: int, aot_fw_gm_num_inputs: int
) -> int: ...
...
def get_free_symbols(
    x: IterateExprs, unbacked_only: bool
) -> OrderedSet[sympy.Symbol]: ...
def maybe_log_cudagraph_partition(
    msg: str, prefix: str | None = ..., node: BaseSchedulerNode | None = ...
) -> None: ...
