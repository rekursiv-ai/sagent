...
def createResolutionCallbackFromFrame(
    frames_up: int = ...,
) -> Callable[..., Any | None]: ...
...
# Identity at runtime; it only tags `_torchscript_modifier`. Undeclared, it
# resolves to Unknown and erases every container dunder it decorates.
