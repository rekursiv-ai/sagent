...
def copy(
    a: ArrayLike, order: NotImplementedType = ..., subok: NotImplementedType = ...
): ...
def copyto(
    dst: NDArray,
    src: ArrayLike,
...
def array_split(
    ary: ArrayLike, indices_or_sections, axis=...
) -> tuple[Tensor, ...]: ...
...
def bincount(
    x: ArrayLike, /, weights: ArrayLike | None = ..., minlength=...
) -> Tensor: ...
def where(
    condition: ArrayLike,
...
def tri(
    N, M=..., k=..., dtype: DTypeLike | None = ..., *, like: NotImplementedType = ...
) -> Tensor: ...
def isclose(
    a: ArrayLike, b: ArrayLike, rtol=..., atol=..., equal_nan=...
) -> Tensor: ...
...
def nan_to_num(
    x: ArrayLike, copy: NotImplementedType = ..., nan=..., posinf=..., neginf=...
) -> Tensor: ...
def take(
    a: ArrayLike,
    indices: ArrayLike,
...
def put(
    a: NDArray, indices: ArrayLike, values: ArrayLike, mode: NotImplementedType = ...
) -> None: ...
def put_along_axis(
    arr: ArrayLike, indices: ArrayLike, values: ArrayLike, axis
) -> None: ...
def choose(
    a: ArrayLike,
...
def identity(
    n, dtype: DTypeLike | None = ..., *, like: NotImplementedType = ...
) -> Tensor: ...
...
def cross(
    a: ArrayLike, b: ArrayLike, axisa=..., axisb=..., axisc=..., axis=...
) -> Tensor: ...
def einsum(
...
def argsort(
    a: ArrayLike, axis=..., kind=..., order: NotImplementedType = ...
) -> Tensor: ...
def searchsorted(
    a: ArrayLike, v: ArrayLike, side=..., sorter: ArrayLike | None = ...
): ...
...
def round(
    a: ArrayLike, decimals=..., out: OutArray | None = ...
) -> Tensor | ArrayLike: ...
