...
_P = ParamSpec("_P")
log = ...
if os.path.basename(os.path.dirname(__file__)) == "shared":  # noqa: PTH119, PTH120 -- mirrors upstream os.path runtime code
    torch_parent = ...
else:
    torch_parent = ...
...
def add_mlhub_insight(
    category: str, insight: str, insight_description: str
) -> None: ...
