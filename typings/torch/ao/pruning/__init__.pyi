...
from .sparsifier.nearly_diagonal_sparsifier import (
    NearlyDiagonalSparsifier as NearlyDiagonalSparsifier,
)
from .sparsifier.utils import (
    FakeSparsity as FakeSparsity,
    fqn_to_module as fqn_to_module,
    get_arg_info_from_tensor_fqn as get_arg_info_from_tensor_fqn,
    module_to_fqn as module_to_fqn,
)
