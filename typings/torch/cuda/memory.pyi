...
def use_mem_pool(pool: MemPool, device: Device = ...) -> Generator[None, Any]: ...
def _record_memory_history(
    ...
    global_record_annotations: bool = ...,
) -> None: ...
def _dump_snapshot(filename: str = ...) -> None: ...
def _snapshot(device: object = ...) -> dict[str, Any]: ...
