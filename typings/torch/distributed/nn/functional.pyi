...
def gather(tensor, dst=..., group=...) -> None: ...
def scatter(tensors, src=..., group=...) -> None: ...
def reduce(tensor, dst, op=..., group=...) -> None: ...
def reduce_scatter(output, input_list, op=..., group=...) -> None: ...
