...
class _node_list:
    def __init__(
        self, graph: Graph, direction: Literal["_prev", "_next"] = ...
    ) -> None: ...
...
class CodeGen:
    ...
    def generate_output(
        self, output_args: Argument, *, descs: Any | None = ...
    ) -> str: ...
...
class _PyTreeCodeGen(CodeGen):
    ...
    def gen_fn_def(
        self, free_vars, maybe_return_annotation, *, expanded_def: bool = ...
    ) -> str: ...
...
class Graph:
    ...
    @compatibility(is_backward_compatible=False)
    def find_nodes(
        self, *, op: str, target: Target | None = ..., sort: bool = ...
    ) -> list[Node]: ...
    @compatibility(is_backward_compatible=True)
    def graph_copy(
        self, g: Graph, val_map: dict[Node, Node], return_output_node=...
    ) -> Argument | None: ...
    ...
    @compatibility(is_backward_compatible=True)
    def placeholder(
        self, name: str, type_expr: Any | None = ..., default_value: Any = ...
    ) -> Node: ...
    @compatibility(is_backward_compatible=True)
    ...
    def eliminate_dead_code(
        self, is_impure_node: Callable[[Node], bool] | None = ...
    ) -> bool: ...
    @compatibility(is_backward_compatible=False)
