...
class ExprBuilder(Builder):
    ...
    @staticmethod
    def build_Name(ctx, expr) -> Dots | Var: ...
    @staticmethod
    def build_NameConstant(ctx, expr) -> Dots: ...
    @staticmethod
    def build_BinOp(ctx, expr) -> BinOp: ...
    @staticmethod
    def build_UnaryOp(ctx, expr) -> UnaryOp: ...
    @staticmethod
    def build_BoolOp(ctx, expr) -> BinOp: ...
    @staticmethod
    ...
    @staticmethod
    def build_Constant(ctx, expr) -> Dots | Const | StringLiteral: ...
    @staticmethod
