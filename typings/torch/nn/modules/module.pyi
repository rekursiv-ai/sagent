...
class Module:
    ...
    def register_buffer(
        self, name: str, tensor: Tensor | None, persistent: bool = ...
    ) -> None: ...
    ...
    def set_submodule(
        self, target: str, module: Module, strict: bool = ...
    ) -> None: ...
    def get_parameter(self, target: str) -> Parameter: ...
    def get_buffer(self, target: str) -> Tensor: ...
    def get_extra_state(self) -> Any: ...
    def set_extra_state(self, state: Any) -> None: ...
    def _apply(self, fn: Callable[..., None], recurse: bool = True) -> Self: ...
    ...
    def to_empty(
        self, *, device: DeviceLikeType | None, recurse: bool = ...
    ) -> Self: ...
    @overload
    def to(
        self,
    ...
    def state_dict(
        self, *args, destination=..., prefix=..., keep_vars=...
    ) -> OrderedDict[Any, Any]: ...
