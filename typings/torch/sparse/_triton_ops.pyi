...
def slicer(dim, slice_range, *tensors) -> Generator[Any, Any]: ...
def multidim_slicer(dims, slices, *tensors) -> Generator[Any, Any]: ...
def ptr_stride_extractor(*tensors) -> Generator[Any, Any]: ...
def grid_partitioner(
    full_grid, grid_blocks, tensor_dims_map
) -> Generator[tuple[list[Any], *tuple[Any, ...]], Any]: ...
