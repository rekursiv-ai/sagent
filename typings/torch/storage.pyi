...
class _StorageBase:
    ...
    def size(self) -> _int: ...
    def type(
        self, dtype: str | None = ..., non_blocking: _bool = ...
    ...
    def mps(self) -> Self: ...
    def to(
        self, *, device: DeviceLikeType, non_blocking: _bool = ...
    ) -> UntypedStorage | Any: ...
...
class TypedStorage:
    ...
    def __new__(
        cls, *args, wrap_storage=..., dtype=..., device=..., _internal=...
    ) -> Self | TypedStorage: ...
    def __init__(
        self, *args, device=..., dtype=..., wrap_storage=..., _internal=...
    ) -> None: ...
    @property
    def is_cuda(self) -> bool: ...
    @property
    ...
    def nbytes(self) -> int: ...
    def type(
        self, dtype: str | None = ..., non_blocking: bool = ...
    ...
    def get_device(self) -> _int: ...
    def __iter__(self) -> Iterator[Number | Any]: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo) -> Self: ...
    def __sizeof__(self) -> int: ...
    def clone(self) -> Self: ...
