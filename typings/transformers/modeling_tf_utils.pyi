...
class TFPreTrainedModel(
    ...
    def set_input_embeddings(self, value):  # -> None:
        ...
    def get_output_embeddings(self) -> keras.layers.Layer | None: ...
    def set_output_embeddings(self, value):  # -> None:
        ...
    def get_output_layer_with_bias(self) -> keras.layers.Layer | None: ...
    def get_prefix_bias_name(self) -> str | None: ...
    def get_bias(self) -> dict[str, tf.Variable] | None: ...
