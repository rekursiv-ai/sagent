...
class PreTrainedModel(
    ...
    def gradient_checkpointing_enable(
        self,
        gradient_checkpointing_kwargs: Mapping[str, object] | None = ...,
        every_n_layers: int = ...,
    ) -> None: ...
    ...
    def get_memory_footprint(self, return_buffers=...):  # -> int:
        ...
    # ``@wraps(torch.nn.Module.to)`` in the source; spelled as the wrapped
    # signature here because ``wraps`` erases it for both checkers.
