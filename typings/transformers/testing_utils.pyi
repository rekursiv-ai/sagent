...
from pytest import (  # noqa: PT013 -- not a real test module; mirrors upstream import
    DoctestItem,
)
...
class TemporaryHubRepo:
    def __init__(
        self, namespace: str | None = ..., token: str | None = ...
    ) -> None: ...
...
def execute_subprocess_async(
    cmd, env=..., stdin=..., timeout=..., quiet=..., echo=...
) -> _RunOutput: ...
...
def patch_torch_compile_force_graph():  # -> None:
    ...
def patch_testing_methods_to_collect_info():  # -> None:
    ...
def torchrun(
    script: str, nproc_per_node: int, is_torchrun: bool = ..., env: dict | None = ...
):  # -> None:
    ...
