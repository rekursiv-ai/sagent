...
_torch_available = ...
if (
    USE_TORCH in ENV_VARS_TRUE_AND_AUTO_VALUES and USE_TF not in ENV_VARS_TRUE_VALUES
): ...
else:
    _torch_available = ...
_tf_version = ...
...
def is_cv2_available() -> tuple[bool, str] | bool: ...
def is_yt_dlp_available() -> tuple[bool, str] | bool: ...
def is_torch_available() -> tuple[bool, str] | bool: ...
...
def is_torch_optimi_available() -> tuple[bool, str] | bool: ...
...
def is_essentia_available() -> tuple[bool, str] | bool: ...
def is_pydantic_available() -> tuple[bool, str] | bool: ...
def is_fastapi_available() -> tuple[bool, str] | bool: ...
def is_uvicorn_available() -> tuple[bool, str] | bool: ...
def is_openai_available() -> tuple[bool, str] | bool: ...
def is_pretty_midi_available() -> tuple[bool, str] | bool: ...
...
def is_torch_bf16_cpu_available() -> tuple[bool, str] | bool: ...
...
def is_torch_fx_available() -> tuple[bool, str] | bool: ...
def is_peft_available() -> tuple[bool, str] | bool: ...
def is_bs4_available() -> tuple[bool, str] | bool: ...
...
@lru_cache
def is_torch_npu_available(check_device=...) -> bool: ...
@lru_cache
def is_torch_mlu_available() -> bool: ...
@lru_cache
def is_torch_musa_available(check_device=...) -> bool: ...
@lru_cache
def is_torch_hpu_available() -> bool: ...
@lru_cache
def is_habana_gaudi1() -> bool: ...
def is_torchdynamo_available() -> tuple[bool, str] | bool: ...
def is_torch_compile_available() -> tuple[bool, str] | bool: ...
def is_torchdynamo_compiling() -> tuple[bool, str] | bool: ...
...
@lru_cache
def is_torch_xpu_available(check_device: bool = ...) -> bool: ...
@lru_cache
def is_bitsandbytes_available(check_library_only: bool = ...) -> bool: ...
...
def is_huggingface_hub_greater_or_equal(
    library_version: str, accept_dev: bool = ...
) -> bool: ...
@lru_cache
def is_quanto_greater(library_version: str, accept_dev: bool = ...) -> bool: ...
def is_torchdistx_available():  # -> tuple[bool, str] | bool:
    ...
def is_faiss_available() -> bool: ...
def is_scipy_available() -> tuple[bool, str] | bool: ...
def is_sklearn_available() -> tuple[bool, str] | bool: ...
...
class _LazyModule(ModuleType):
    ...
    def __reduce__(
        self,
    ):  # -> tuple[type[Self], tuple[str, str | None, IMPORT_STRUCTURE_T]]:
        ...
...
def define_import_structure(
    module_path: str, prefix: str | None = ...
) -> IMPORT_STRUCTURE_T: ...
